...
NetworkStringTableContainer* C_CSGO::m_networkStringTableContainerr()
{
	if (!p_networkStringTableContainerr)
		p_networkStringTableContainerr = get_interface<NetworkStringTableContainer>("engine.dll", crypt_str("VEngineClientStringTable"));

	return p_networkStringTableContainerr;
}
