...
void __fastcall hooks::hooked_painttraverse(void* ecx, void* edx, vgui::VPANEL panel, bool force_repaint, bool allow_force)
{
	...
	if (reload_fonts())
	{
		...
		fonts[LOGS] = create_font(crypt_str("Verdana"), 12, FW_MEDIUM, FONTFLAG_DROPSHADOW);
		fonts[KEYBINDSLIST] = create_font(crypt_str("Verdana"), 12, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
		fonts[ESP] = create_font(crypt_str("Arial"), 11, 100, FONTFLAG_OUTLINE);
		fonts[FLAGS] = create_font(crypt_str("DmcaSansSerif-OVZK4"), 11, 100, FONTFLAG_DROPSHADOW);
		fonts[ESP1] = create_font(crypt_str("Smallest Pixel-7"), 11, FW_MEDIUM, FONTFLAG_ANTIALIAS);
		fonts[PLAYERINDICATORS] = create_font(crypt_str("Arial"), 11, 100, FONTFLAG_OUTLINE);
		...
		fonts[NAME] = create_font(crypt_str("DmcaSansSerif-OVZK4"), 12, 400, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
		...
		fonts[GRENADES] = create_font(crypt_str("undefeated"), 30, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
		fonts[GRENADESINDICATOR] = create_font(crypt_str("undefeated"), 35, 10, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
		fonts[INDICATORFONT] = create_font(crypt_str("Calibri"), 26, 600, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
		fonts[DAMAGE_MARKER] = create_font(crypt_str("Calibri"), 18, 10, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
		fonts[KEYBINDS] = create_font(crypt_str("Verdana"), 12, 100, FONTFLAG_DROPSHADOW | FONTFLAG_ANTIALIAS);
		fonts[INDICATORFONT2] = create_font(crypt_str("Calibri"), 26, 600, FONTFLAG_ANTIALIAS);
		fonts[WATERMARK] = create_font(crypt_str("Verdana"), 13, 500, FONTFLAG_DROPSHADOW | FONTFLAG_ANTIALIAS);
