...
void C_ConfigManager::setup()
{
	...
	setup_item(&g_cfg.ragebot.double_tap, false, crypt_str("Exploits.double_tap"));
	setup_item(&g_cfg.ragebot.Double_tap_offensive_ticks, 12, crypt_str("Exploits.OverrideDoubletapSpeed_Offensive"));
	setup_item(&g_cfg.ragebot.Double_tap_defensive_ticks, 14, crypt_str("Exploits.OverrideDoubletapSpeed_Deffensive"));
	setup_item(&g_cfg.ragebot.slow_teleport, false, crypt_str("Exploits.slow_teleport"));
	setup_item(&g_cfg.ragebot.twoshot, false, crypt_str("Exploits.lethal_shot"));
	setup_item(&g_cfg.ragebot.nospread, false, crypt_str("Ragebot.nospread"));
	setup_item(&g_cfg.ragebot.norecoil, false, crypt_str("Ragebot.norecoil"));
	setup_item(&g_cfg.ragebot.quick_peek_assist, false, crypt_str("Ragebot.quick_peek_assist"));
	setup_item(&g_cfg.ragebot.break_lag_comp, false, crypt_str("Exploits.break_lag_comp"));
	setup_item(&g_cfg.ragebot.faster_recharge, false, crypt_str("Exploits.faster_recharge"));
	setup_item(&g_cfg.ragebot.double_tap_key, key_bind(TOGGLE), crypt_str("Exploits.double_tap_key"));
	setup_item(&g_cfg.ragebot.safe_point_key, key_bind(TOGGLE), crypt_str("Ragebot.safe_point_key"));
	setup_item(&g_cfg.ragebot.body_aim_key, key_bind(TOGGLE), crypt_str("Ragebot.body_aim_key"));
	setup_item(&g_cfg.ragebot.antiaim_correction, false, crypt_str("Ragebot.antiaim_correction"));
	setup_item(&g_cfg.ragebot.anti_defensive, false, crypt_str("Ragebot.anti_defensive"));
	...
	for (auto i = 0; i < 8; i++)
	{
		...
		setup_item(&g_cfg.ragebot.weapon[i].Double_tap_ticks_custom, 10, crypt_str("Exploits.OverrideDoubletapSpeed_Custom"));
		setup_item(&g_cfg.ragebot.weapon[i].autoscope, false, std::to_string(i) + crypt_str("Ragebot.autoscope"));
		...
		setup_item(&g_cfg.ragebot.weapon[i].hitchance_override, false, crypt_str("Ragebot.hitchance_override"));
		setup_item(&g_cfg.ragebot.weapon[i].hitchance_override_key, key_bind(TOGGLE), std::to_string(i) + crypt_str("Ragebot.hitchance_override_key"));
		setup_item(&g_cfg.ragebot.weapon[i].hitchance_override_amount, 1, std::to_string(i) + crypt_str("Ragebot.hitchance_override_amount"));
		...
		setup_item(&g_cfg.ragebot.weapon[i].damage_override_key, key_bind(TOGGLE), std::to_string(i) + crypt_str("Ragebot.damage_override_key"));
		...
		setup_item(&g_cfg.ragebot.weapon[i].body_aim_conditions, false, std::to_string(i) + crypt_str("Ragebot.body_aim_conditions"));
		setup_item(&g_cfg.ragebot.weapon[i].bodyaimcond, 4, std::to_string(i) + crypt_str("Ragebot.bodyaim_conditions"));
		setup_item(&g_cfg.ragebot.weapon[i].body_aim_health, 10, std::to_string(i) + crypt_str("Ragebot.body_aim_health"));
		setup_item(&g_cfg.ragebot.weapon[i].autoscope, false, crypt_str("Ragebot.autoscope"));
	}
	...
	setup_item(&g_cfg.antiaim.pitch_zero_on_land, false, crypt_str("Antiaim.no_pitch_land"));
	...
	setup_item(&g_cfg.antiaim.static_legs, false, crypt_str("Antiaim.static_legs_air"));
	...
	setup_item(&g_cfg.antiaim.hide_shots_lag, false, crypt_str("Antiaim.hide_shots_lag"));
	setup_item(&g_cfg.antiaim.double_tap_lag, false, crypt_str("Antiaim.double_tap_lag"));
	setup_item(&g_cfg.antiaim.weapon_fakelag, false, crypt_str("Antiaim.fakelag_weapon"));
	setup_item(&g_cfg.antiaim.fakelag_disable_revolver, false, crypt_str("Antiaim.fakelag_disable_revolver"));
	...
	setup_item(&g_cfg.player.fake_double_material_material, 0, crypt_str("Player.fake_double_material_material"));
	...
	for (auto i = 0; i < 3; i++)
	{
		...
		setup_item(&g_cfg.player.type[i].double_material_material, 0, crypt_str("Player.double_material_material"));
		setup_item(&g_cfg.player.fake_double_material_material, 0, crypt_str("Esp.fake_double_material_material"));
	...
	setup_item(&g_cfg.esp.indicators_left_color, Color(0, 0, 0, 150), crypt_str("Esp.indicators_left_color"));
	setup_item(&g_cfg.esp.indicators_right_color, Color(0, 0, 0, 150), crypt_str("Esp.indicators_right_color"));
	setup_item(&g_cfg.esp.removals, 7, crypt_str("Esp.world_removals"));
	setup_item(&g_cfg.esp.fix_zoom_sensivity, false, crypt_str("Esp.fix_zoom_sensivity"));
	setup_item(&g_cfg.esp.velocity_graph, false, crypt_str("Esp.velocity_graph"));
	setup_item(&g_cfg.esp.drugsmod, false, crypt_str("Esp.drugsmod"));
	setup_item(&g_cfg.esp.drugsmod_type, 0, crypt_str("Esp.drugsmod_type"));
	setup_item(&g_cfg.esp.drugsmod_color, Color(255, 255, 255), crypt_str("Esp.drugsmod_color"));
	setup_item(&g_cfg.esp.drugsmod_double_material, false, crypt_str("Esp.drugsmod_double_material"));
	setup_item(&g_cfg.esp.drugsmod_double_material_color, Color(255, 255, 255), crypt_str("Esp.drugsmod_double_material_color"));
	setup_item(&g_cfg.esp.drugsmod_wire_material, false, crypt_str("Esp.drugsmod_wire_material"));
	setup_item(&g_cfg.esp.drugsmod_wire_material_color, Color(255, 255, 255), crypt_str("Esp.drugsmod_wire_material_color"));
	setup_item(&g_cfg.esp.drugsmod_animated_material, false, crypt_str("Esp.drugsmod_animated_material"));
	setup_item(&g_cfg.esp.drugsmod_animated_material_color, Color(255, 255, 255), crypt_str("Esp.drugsmod_animated_material_color"));
	setup_item(&g_cfg.esp.drugsmod_orig_material, false, crypt_str("Esp.drugsmod_orig_material"));
	...
	setup_item(&g_cfg.esp.MaskChanger, false, crypt_str("Esp.MaskChanger"));
	...
	setup_item(&g_cfg.esp.proximity_tracers_width, 1, crypt_str("Esp.proximity_tracers_width"));
	...
	setup_item(&g_cfg.esp.bullet_impacts_width, 7, crypt_str("Esp.bullet_impacts_width"));
	...
	setup_item(&g_cfg.esp.hitmarker_color, Color(255, 255, 255), crypt_str("Esp.hit_marker_color"));
	...
	setup_item(&g_cfg.esp.damage_marker_color, Color(138, 155, 255), crypt_str("Esp.damage_marker_color"));
	...
	setup_item(&g_cfg.esp.enable_arms_chams, false, crypt_str("Esp.arms_chams_enable"));
	setup_item(&g_cfg.esp.arms_chams, false, crypt_str("Esp.arms_chams"));
	setup_item(&g_cfg.esp.arms_draw_original, true, crypt_str("Esp.arms_draw_original"));
	...
	setup_item(&g_cfg.esp.arms_overlay_chams, 0, crypt_str("Esp.weapon_chams_typeoverlay1"));
	...
	setup_item(&g_cfg.esp.arms_wire_material, false, crypt_str("esp.arm_wire_frame"));
	setup_item(&g_cfg.esp.arms_wire_material_color, Color(255, 255, 255), crypt_str("esp.arm_wire_frame_color"));
	setup_item(&g_cfg.esp.weapon_wire_material, false, crypt_str("esp.weapon_wire_frame"));
	setup_item(&g_cfg.esp.weapon_wire_material_color, Color(255, 255, 255), crypt_str("esp.weapon_wire_frame_color"));
	setup_item(&g_cfg.esp.arms_animated_material_color, Color(255, 255, 255), crypt_str("Esp.arms_animated_material_color"));
	...
	setup_item(&g_cfg.esp.weapon_overlay_chams, 0, crypt_str("Esp.weapon_chams_typeoverlay"));
	...
	setup_item(&g_cfg.misc.automatic_peek, key_bind(TOGGLE), crypt_str("Misc.quick_peek_assist_key"));
	setup_item(&g_cfg.misc.automatic_peek_color, Color(147, 190, 66, 200), crypt_str("Misc.quick_peek_assist_color"));
	setup_item(&g_cfg.misc.edge_jump, key_bind(HOLD), crypt_str("Misc.edge_jump"));
	setup_item(&g_cfg.misc.edgebug, key_bind(HOLD), crypt_str("Misc.edgebug"));
	...
	setup_item(&g_cfg.misc.fake_ping, false, crypt_str("Misc.ping_spike"));
	setup_item(&g_cfg.misc.ping, 1, crypt_str("Misc.ping_spike_amount"));
	...
	setup_item(&g_cfg.menu.menu_theme, Color(32, 32, 32), crypt_str("Menu.menu_color"));
	setup_item(&g_cfg.menu.watermark, false, crypt_str("Menu.watermark"));
	setup_item(&g_cfg.menu.watermark_color, Color(147, 190, 66,255), crypt_str("Menu.watermark_color"));
	setup_item(&g_cfg.menu.watermark_color_background, Color(32, 32, 32), crypt_str("Menu.watermark_color_background"));
...
{
	std::string file = crypt_str("C:\\Medusa.uno\\Configs\\") + config;
	json allJson;
...
{
	std::string file = crypt_str("C:\\Medusa.uno\\Configs\\");

	files.clear();

	std::string path = file + crypt_str("/*.uno");
	WIN32_FIND_DATA fd;
