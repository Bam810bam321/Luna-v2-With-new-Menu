...
public:
	...
	inline void RenderBoxFilled(ImVec2 xy1, ImVec2 xy2, Color color, float thickness = 1.f, float rounding = 0.f) {
		draw_list->AddRectFilled(ImVec2(xy1), ImVec2(xy2), GetU32(color), rounding, 15);
	}
	template <class T>
	inline void RenderBoxFilledGradient(T x1, T y1, T x2, T y2, Color color, Color color2, Color color3, Color color4) {
		draw_list->AddRectFilledMultiColor(ImVec2(x1, y1), ImVec2(x2, y2), GetU32(color), GetU32(color2), GetU32(color3), GetU32(color4));
	}
	inline void RenderBoxFilledGradient(ImVec2 xy1, ImVec2 xy2, Color color, Color color2, Color color3, Color color4) {
		draw_list->AddRectFilledMultiColor(ImVec2(xy1), ImVec2(xy2), GetU32(color), GetU32(color2), GetU32(color3), GetU32(color4));
	}
	template <class T>
