...
namespace ImGui
{
    ...
    IMGUI_API bool          PlusButton(const char* label, bool type, const ImVec2& size_arg, const char* uniq_id, ImColor col, bool config);
    IMGUI_API bool          KeybindButton(const char* label, const char* unique_id, const ImVec2& size_arg = ImVec2(0, 0), bool clicked = false, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          CustomButton(const char* label, const char* id, const ImVec2& size_arg = ImVec2(0, 0), bool use_icon = false, ImFont* icon_font = nullptr, const char* icon_label = nullptr);
    IMGUI_API bool          MainTab(const char* label, ImFont* icon_font, const char* icon, bool active = false, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          ContentTab(const char* label, bool active = false, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
