...
bool elements::tab(const char* name, bool boolean)
{
    ...
    const ImVec2 label_size = c_menu::get().tab_icons->CalcTextSizeA(15.0f, FLT_MAX, 0.0f, name);
    ...
    window->DrawList->AddText(c_menu::get().tab_icons, 15.0f, (rect.Min + rect.Max - label_size) / 2, ImColor(1.0f, 1.0f, 1.0f, it_anim->second.text_opacity), name);

    window->DrawList->AddRectFilled(ImVec2(rect.Max.x + 4, rect.Min.y + 6), ImVec2(rect.Max.x + 8, rect.Max.y - 6), ImColor(147 / 255.0f, 190 / 255.0f, 66 / 255.0f, it_anim->second.rect_opacity), 7.0f, ImDrawCornerFlags_TopLeft);
...
bool elements::subtab(const char* name, bool boolean)
{
    ...
    window->DrawList->AddRectFilled(ImVec2(rect.Max.x + 5, rect.Min.y + 9), ImVec2(rect.Max.x + 8, rect.Max.y - 9), ImColor(147 / 255.0f, 190 / 255.0f, 66 / 255.0f, it_anim->second.rect_opacity), 10.0f, ImDrawCornerFlags_TopLeft);
