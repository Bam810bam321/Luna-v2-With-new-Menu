...
public:
    ...
    static void draws(ImDrawList* drawList, const ImVec2& p_min, const ImVec2& p_max, float alpha) noexcept
    {
...
void PostProcessing::performBlur(ImDrawList* drawList, const ImVec2& p_min, const ImVec2& p_max, float alpha) noexcept
{
